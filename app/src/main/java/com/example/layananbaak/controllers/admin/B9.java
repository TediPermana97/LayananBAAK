...
import com.example.layananbaak.controllers.user.B9Registrasi;
...
public class B9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pages_b9);
        context = B9.this;
         ...
         * BOTTOM SHEET ADD
         */
        LayoutInflater layoutInflaterAndroid = LayoutInflater.from(B9.this);
        bottomSheetLayout = layoutInflaterAndroid.inflate(R.layout.bottomsheet_b9, null);
        mBottomSheetDialog = new BottomSheetDialog(B9.this);
        ...
        if (resultCode == RESULT_OK && data != null) {
            ...
            if (!file.exists()) {
                ...
                if (requestCode == FILE_SELECT) {
                    ...
                    StorageReference ref = storageReference.child(uid+"/files/stls_"+namaFile);
                    ref.putFile(uri)
                            .addOnSuccessListener(taskSnapshot -> {
                                progressDialog.dismiss();
                                Toast.makeText(B9.this, "Uploaded", Toast.LENGTH_SHORT).show();
                                ...
                                ref.getDownloadUrl().addOnSuccessListener(uri1 -> {
                                    ...
                                    db.collection("stls")
                                            .document(docId)
                                            .set(new STLS(uri1.toString()), SetOptions.mergeFields("file_stls")
                                            )
                                            .addOnSuccessListener(documentReference -> {
                                                ...
                                                //editKeyFoto.setText("");
                                                Toast.makeText(B9.this, "File telah tersimpan", Toast.LENGTH_SHORT).show();
                                            });
                                });
                            ...
                            .addOnFailureListener(e -> {
                                progressDialog.dismiss();
                                Toast.makeText(B9.this, "Failed " + e.getMessage(), Toast.LENGTH_SHORT).show();
                            })
    ...
    private void getList(){
        ...
        Query query = db.collection("stls").orderBy("tanggal", Query.Direction.DESCENDING);
            ...
            public void onBindViewHolder(AdapterViewHolder holder, int position, STLS model) {
                ...
                holder.action_del.setOnClickListener(view -> {
                    ...
                    sweetAlertDialog.setConfirmClickListener(sDialog -> {
                        ...
                        db.collection("stls" ).document(docId).delete();
                    });
                ...
                holder.itemView.setOnClickListener(view -> {
                    ...
                    editKeyJudul.setText(model.tahun_akademik);
                    ...
                    xtv1.setText(model.tahun_akademik);
                    xtv2.setText(model.file_persyaratan);
                    xtv3.setText(model.verifikasi_kode);
