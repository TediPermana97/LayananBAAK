...
import com.example.layananbaak.controllers.user.B7Registrasi;
...
public class B7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pages_b7);
        context = B7.this;
         ...
         * BOTTOM SHEET ADD
         */
        LayoutInflater layoutInflaterAndroid = LayoutInflater.from(B7.this);
        bottomSheetLayout = layoutInflaterAndroid.inflate(R.layout.bottomsheet_b7, null);
        mBottomSheetDialog = new BottomSheetDialog(B7.this);
        ...
        if (resultCode == RESULT_OK && data != null) {
            ...
            if (!file.exists()) {
                ...
                if (requestCode == FILE_SELECT) {
                    ...
                    StorageReference ref = storageReference.child(uid+"/files/pindahkelas_"+namaFile);
                    ref.putFile(uri)
                            .addOnSuccessListener(taskSnapshot -> {
                                progressDialog.dismiss();
                                Toast.makeText(B7.this, "Uploaded", Toast.LENGTH_SHORT).show();

                                ref.getDownloadUrl().addOnSuccessListener(uri1 -> {
                                    Log.d(TAG, "onSuccess: uri= " + uri1.toString());
                                    //editKeyFoto.setText(uri.toString());

                                    db.collection("pindahkelas")
                                            .document(docId)
                                            .set(new PindahKelas(uri1.toString()), SetOptions.mergeFields("file_pindahkelas")
                                            )
                                            .addOnSuccessListener(documentReference -> {
                                                ...
                                                //editKeyFoto.setText("");
                                                Toast.makeText(B7.this, "File telah tersimpan", Toast.LENGTH_SHORT).show();
                                            });
                                });
                            ...
                            .addOnFailureListener(e -> {
                                progressDialog.dismiss();
                                Toast.makeText(B7.this, "Failed " + e.getMessage(), Toast.LENGTH_SHORT).show();
                            })
    ...
    private void getList(){
        ...
        Query query = db.collection("pindahkelas").orderBy("tanggal", Query.Direction.DESCENDING);
            ...
            public void onBindViewHolder(AdapterViewHolder holder, int position, PindahKelas model) {
                ...
                holder.action_del.setOnClickListener(view -> {
                    ...
                    sweetAlertDialog.setConfirmClickListener(sDialog -> {
                        ...
                        db.collection("pindahkelas" ).document(docId).delete();
                    });
                ...
                holder.itemView.setOnClickListener(view -> {
                    ...
                    editKeyJudul.setText(model.alasan_pindah);
                    ...
                    xtv1.setText(model.kelas_sebelumnya);
                    xtv2.setText(model.alasan_pindah);
