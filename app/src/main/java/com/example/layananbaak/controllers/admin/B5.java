...
import com.example.layananbaak.controllers.user.B5Registrasi;
...
public class B5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pages_b5);
        context = B5.this;
         ...
         * BOTTOM SHEET ADD
         */
        LayoutInflater layoutInflaterAndroid = LayoutInflater.from(B5.this);
        bottomSheetLayout = layoutInflaterAndroid.inflate(R.layout.bottomsheet_b5, null);
        mBottomSheetDialog = new BottomSheetDialog(B5.this);
        ...
        if (resultCode == RESULT_OK && data != null) {
            ...
            if (!file.exists()) {
                ...
                if (requestCode == FILE_SELECT) {
                    ...
                    StorageReference ref = storageReference.child(uid+"/files/sip_"+namaFile);
                    ref.putFile(uri)
                            .addOnSuccessListener(taskSnapshot -> {
                                progressDialog.dismiss();
                                Toast.makeText(B5.this, "Uploaded", Toast.LENGTH_SHORT).show();
                                ...
                                ref.getDownloadUrl().addOnSuccessListener(uri1 -> {
                                    ...
                                    db.collection("sip")
                                            .document(docId)
                                            .set(new SIP(uri1.toString()), SetOptions.mergeFields("file_sip")
                                            )
                                            .addOnSuccessListener(documentReference -> {
                                                ...
                                                //editKeyFoto.setText("");
                                                Toast.makeText(B5.this, "File telah tersimpan", Toast.LENGTH_SHORT).show();
                                            });
                                });
                            ...
                            .addOnFailureListener(e -> {
                                progressDialog.dismiss();
                                Toast.makeText(B5.this, "Failed " + e.getMessage(), Toast.LENGTH_SHORT).show();
                            })
    ...
    private void getList(){
        ...
        Query query = db.collection("sip").orderBy("tanggal", Query.Direction.DESCENDING);
        ...
        adapter = new FirestoreRecyclerAdapter<SIP, AdapterViewHolder>(response) {
            ...
            public void onBindViewHolder(AdapterViewHolder holder, int position, SIP model) {
                ...
                holder.itemView.setOnClickListener(view -> {
                    ...
                    editKeyJudul.setText(model.judul_penelitian);
                    ...
                    xtv4.setText(model.tanggal_mulai_penelitian);
                    xtv5.setText(model.tanggal_akhir_penelitian);
                    xtv6.setText(model.judul_penelitian);
