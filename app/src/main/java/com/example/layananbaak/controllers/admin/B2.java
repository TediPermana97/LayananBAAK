...
import com.example.layananbaak.controllers.user.B2Registrasi;
...
public class B2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pages_b2);
        context = B2.this;
         ...
         * BOTTOM SHEET ADD
         */
        LayoutInflater layoutInflaterAndroid = LayoutInflater.from(B2.this);
        bottomSheetLayout = layoutInflaterAndroid.inflate(R.layout.bottomsheet_b2, null);
        mBottomSheetDialog = new BottomSheetDialog(B2.this);
        ...
        if (resultCode == RESULT_OK && data != null) {
            ...
            if (!file.exists()) {
                ...
                if (requestCode == FILE_SELECT) {
                    ...
                    StorageReference ref = storageReference.child(uid+"/files/skm_"+namaFile);
                    ref.putFile(uri)
                            .addOnSuccessListener(taskSnapshot -> {
                                progressDialog.dismiss();
                                Toast.makeText(B2.this, "Uploaded", Toast.LENGTH_SHORT).show();
                                ...
                                ref.getDownloadUrl().addOnSuccessListener(uri1 -> {
                                    ...
                                    db.collection("skm")
                                            .document(docId)
                                            .set(new SKM(uri1.toString()), SetOptions.mergeFields("file_skm")
                                            )
                                            .addOnSuccessListener(documentReference -> {
                                                ...
                                                //editKeyFoto.setText("");
                                                Toast.makeText(B2.this, "File telah tersimpan", Toast.LENGTH_SHORT).show();
                                            });
                                });
                            ...
                            .addOnFailureListener(e -> {
                                progressDialog.dismiss();
                                Toast.makeText(B2.this, "Failed " + e.getMessage(), Toast.LENGTH_SHORT).show();
                            })
    ...
    private void getList(){
        ...
        Query query = db.collection("skm").orderBy("tanggal", Query.Direction.DESCENDING);
            ...
            public void onBindViewHolder(AdapterViewHolder holder, int position, SKM model) {
                ...
                holder.action_del.setOnClickListener(view -> {
                    ...
                    sweetAlertDialog.setConfirmClickListener(sDialog -> {
                        ...
                        db.collection("skm" ).document(docId).delete();
                    });
                ...
                holder.itemView.setOnClickListener(view -> {
                    ...
                    editKeyJudul.setText(model.keperluan_surat);
                    ...
                    xtv1.setText(model.nik_ortu);
                    xtv2.setText(model.nama_ortu);
                    xtv3.setText(model.pekerjaan_ortu);
                    xtv4.setText(model.keperluan_surat);
