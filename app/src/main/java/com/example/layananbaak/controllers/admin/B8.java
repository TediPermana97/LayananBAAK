...
import com.example.layananbaak.controllers.user.B8Registrasi;
...
public class B8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pages_b8);
        context = B8.this;
         ...
         * BOTTOM SHEET ADD
         */
        LayoutInflater layoutInflaterAndroid = LayoutInflater.from(B8.this);
        bottomSheetLayout = layoutInflaterAndroid.inflate(R.layout.bottomsheet_b8, null);
        mBottomSheetDialog = new BottomSheetDialog(B8.this);
        ...
        if (resultCode == RESULT_OK && data != null) {
            ...
            if (!file.exists()) {
                ...
                if (requestCode == FILE_SELECT) {
                    ...
                    StorageReference ref = storageReference.child(uid+"/files/pindahprogramstudi_"+namaFile);
                    ref.putFile(uri)
                            .addOnSuccessListener(taskSnapshot -> {
                                progressDialog.dismiss();
                                Toast.makeText(B8.this, "Uploaded", Toast.LENGTH_SHORT).show();

                                ref.getDownloadUrl().addOnSuccessListener(uri1 -> {
                                    Log.d(TAG, "onSuccess: uri= " + uri1.toString());
                                    //editKeyFoto.setText(uri.toString());

                                    db.collection("pindahprogramstudi")
                                            .document(docId)
                                            .set(new PindahProgramStudi(uri1.toString()), SetOptions.mergeFields("file_pindahstudi")
                                            )
                                            .addOnSuccessListener(documentReference -> {
                                                ...
                                                //editKeyFoto.setText("");
                                                Toast.makeText(B8.this, "File telah tersimpan", Toast.LENGTH_SHORT).show();
                                            });
                                });
                            ...
                            .addOnFailureListener(e -> {
                                progressDialog.dismiss();
                                Toast.makeText(B8.this, "Failed " + e.getMessage(), Toast.LENGTH_SHORT).show();
                            })
    ...
    private void getList(){
        ...
        Query query = db.collection("pindahprogramstudi").orderBy("tanggal", Query.Direction.DESCENDING);
        ...
        adapter = new FirestoreRecyclerAdapter<PindahProgramStudi, AdapterViewHolder>(response) {
            ...
            public void onBindViewHolder(AdapterViewHolder holder, int position, PindahProgramStudi model) {
                ...
                holder.itemView.setOnClickListener(view -> {
                    ...
                    xtv1.setText(model.pindahke_programstudi);
