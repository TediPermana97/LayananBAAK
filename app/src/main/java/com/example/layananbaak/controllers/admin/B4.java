...
import com.example.layananbaak.controllers.user.B4Registrasi;
...
public class B4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pages_b4);
        context = B4.this;
         ...
         * BOTTOM SHEET ADD
         */
        LayoutInflater layoutInflaterAndroid = LayoutInflater.from(B4.this);
        bottomSheetLayout = layoutInflaterAndroid.inflate(R.layout.bottomsheet_b4, null);
        mBottomSheetDialog = new BottomSheetDialog(B4.this);
                ...
                if (requestCode == FILE_SELECT) {
                    ...
                    ref.putFile(uri)
                            .addOnSuccessListener(taskSnapshot -> {
                                ...
                                Toast.makeText(B4.this, "Uploaded", Toast.LENGTH_SHORT).show();

                                ref.getDownloadUrl().addOnSuccessListener(uri1 -> {
                                    Log.d(TAG, "onSuccess: uri= " + uri1.toString());
                                    //editKeyFoto.setText(uri.toString());

                                    db.collection("aktifakademik")
                                            .document(docId)
                                            .set(new AktifAkademik(uri1.toString()), SetOptions.mergeFields("file_aktifakademik")
                                            )
                                            .addOnSuccessListener(documentReference -> {
                                                ...
                                                //editKeyFoto.setText("");
                                                Toast.makeText(B4.this, "File telah tersimpan", Toast.LENGTH_SHORT).show();
                                            });
                                });
                            ...
                            .addOnFailureListener(e -> {
                                progressDialog.dismiss();
                                Toast.makeText(B4.this, "Failed " + e.getMessage(), Toast.LENGTH_SHORT).show();
                            })
    ...
    private void getList(){
        ...
        Query query = db.collection("aktifakademik").orderBy("tanggal", Query.Direction.DESCENDING);
            ...
            public void onBindViewHolder(AdapterViewHolder holder, int position, AktifAkademik model) {
                ...
                holder.action_del.setOnClickListener(view -> {
                    ...
                    sweetAlertDialog.setConfirmClickListener(sDialog -> {
                        ...
                        db.collection("aktifakademik" ).document(docId).delete();
                    });
                ...
                holder.itemView.setOnClickListener(view -> {
                    ...
                    editKeyJudul.setText(model.tanggal.toString());
